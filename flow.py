...
if __name__ == "__main__":
    ...
    if args.data == 'mnist':
        ...
        train_loader = torch.utils.data.DataLoader(mnist_data, batch_size=args.batch_size, shuffle=True)
        test_loader = torch.utils.data.DataLoader(mnist_data, batch_size=args.batch_size, shuffle=True)

    elif args.data in ['tg', 'cb']:
        n_data = 10000000
